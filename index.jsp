...
<style>
body{background: #fff url(images/jiaoshi.jpg) 50% 0 no-repeat;margin:0;padding:0;}
...
<div id="login">
    ...
    <div class="copyright"><br>学生网上选课系统</div>
</div>
<script>
